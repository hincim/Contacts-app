...
import 'package:uygmimarisikisiler_uyg/sqlite/database_assistant.dart';
...
class KisilerDaoRepository {
  ...
  Future<List<Kisiler>> tumKisileriAl() async {
    ...
    return List.generate(maps.length, (i) {
      var satir = maps[i];
      return Kisiler(
          kisi_id: satir["kisi_id"] as int,
          kisi_ad: satir["kisi_ad"] as String,
          kisi_tel: satir["kisi_tel"] as String);
    });
  }
